...
# Note: Using latest stable version 1.24.4 instead of 1.24.0
# Go team recommends using the latest patch version for security updates
# For SHA256 verification, you can get the checksum from https://go.dev/dl/
# after downloading the specific file
